...
public class BBAssignmentStatementImpl extends ASTWrapperPsiElement implements BBAssignmentStatement {

  public BBAssignmentStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BBFunctionInvocation getFunctionInvocation() {
    return findNotNullChildByClass(BBFunctionInvocation.class);
  }
