...
public class BBAppFunctionDefinitionImpl extends ASTWrapperPsiElement implements BBAppFunctionDefinition {

  public BBAppFunctionDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BBVisitor visitor) {
    visitor.visitAppFunctionDefinition(this);
  }
