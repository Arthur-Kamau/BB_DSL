...
public class BBVariableDefinitionImpl extends ASTWrapperPsiElement implements BBVariableDefinition {

  public BBVariableDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BBType getType() {
    return findNotNullChildByClass(BBType.class);
  }
