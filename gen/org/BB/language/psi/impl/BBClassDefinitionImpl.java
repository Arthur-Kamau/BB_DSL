...
public class BBClassDefinitionImpl extends ASTWrapperPsiElement implements BBClassDefinition {

  public BBClassDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BBFunctionBody getFunctionBody() {
    return findChildByClass(BBFunctionBody.class);
  }

  @Override
  @NotNull
  public List<BBFunctionDefinition> getFunctionDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BBFunctionDefinition.class);
  }
